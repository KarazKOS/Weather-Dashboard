...
$(".search-button").on("click", function (event) {
    ...
    $.ajax({
        ...
        var uvQueryURL = "https://api.openweathermap.org/data/2.5/uvi?" + "lat=" + data.coord.lat + "&lon=" + data.coord.lon + "&appid=62d91493d7a00cb94bd331300d7424aa"
...
$("#city-list").on("click", "button", function () {
    ...
    $.ajax({
        ...
        buildWeatherCardData(data)
        let uvQueryURL = "https://api.openweathermap.org/data/2.5/uvi?" + "lat=" + data.coord.lat + "&lon=" + data.coord.lon + "&appid=62d91493d7a00cb94bd331300d7424aa"
